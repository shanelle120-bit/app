      ...
      {!isAdmin ? (
        ...
        <>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <View style={styles.row} testID="admin-users-row">
                ...
                <View style={{ alignItems: "flex-end" }}>
                  <View style={[styles.tierPill, item.tier === "premium" && { backgroundColor: colors.brandSoft }]}>
                    <Text style={[styles.tierPillText, item.tier === "premium" && { color: colors.brandPrimary }]}>{item.tier}</Text>
                  </View>
