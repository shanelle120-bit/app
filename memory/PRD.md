...
- P1: Real payments for Premium (RevenueCat) + pricing decision; Accountability Partners / Trading Only rooms (registry entries exist, `available: false`). Mingle: verification.
